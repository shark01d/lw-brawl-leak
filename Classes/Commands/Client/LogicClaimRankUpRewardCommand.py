...
class LogicClaimRankUpRewardCommand(LogicCommand):
    ...
    def encode(self, fields):
        ...
        self.writeVInt(0) # bruhler
        self.writeVInt(7) # id
        self.writeVInt(0) # skin
        self.writeVInt(0) # emote
        self.writeVInt(0) # 23 csv
    ...
    def decode(self, calling_instance):
        fields = {}
        fields["1"] = calling_instance.readVInt()
        fields["2"] = calling_instance.readVInt()
        fields["3"] = calling_instance.readVInt()
        fields["4"] = calling_instance.readVInt()
        fields["5"] = calling_instance.readVInt()
        fields["6"] = calling_instance.readVInt()        
